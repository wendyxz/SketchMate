...
class PathTools() {
    ...
    private fun lineIntersect(first: Line, second: Line): Boolean {
        return (
                (isCounterClockWise(first.first, second.first, second.second) != isCounterClockWise(
                    first.second,
                    second.first,
                    second.second
                ))
                        &&
                        (isCounterClockWise(first.first, first.second, second.first) != isCounterClockWise(
                            first.first,
                            first.second,
                            second.second
                        ))
